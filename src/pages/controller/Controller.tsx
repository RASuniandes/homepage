      ...
      <div className='max-w-5xl mx-auto mt-12'>
        ...
        >
          ...
          <div className='flex items-center gap-3 mt-2'>
            ...
            <span className='text-yellow-500 font-bold tracking-widest text-sm uppercase'>
              {isConnected
                ? 'System Online'
                : 'System Offline - Check ROSBridge'}
            </span>
          </div>
        </motion.div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            ...
            <div className='bg-gradient-to-br from-red-900/10 to-transparent border border-red-900/30 p-6 rounded-xl'>
              ...
              <div className='grid grid-cols-2 gap-4 text-xs font-mono'>
                <div className='text-gray-400'>
                  NODE_STATUS: <span className='text-white'>ACTIVE</span>
                </div>
                <div className='text-gray-400'>
                  LATENCY: <span className='text-white'>12ms</span>
                </div>
                <div className='text-gray-400'>
                  TOPIC: <span className='text-white'>/movement</span>
                </div>
                <div className='text-gray-400'>
                  IP: <span className='text-white'>192.168.0.108</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            onKeyDown={e =>
              keyToIndex[e.key] !== undefined && sendCommand(e.key)
            }
            tabIndex={0}
          >
  ...
  return (
    <div className='space-y-4'>
      <div className='flex justify-between items-end'>
        <label className='text-xl font-bold tracking-widest text-gray-400 uppercase'>
          {label}
        </label>
        <div className='text-3xl font-black text-white italic'>
          {value}
          <span className='text-sm text-yellow-500 ml-1 font-normal not-italic'>
            {unit}
          </span>
        </div>
      </div>
